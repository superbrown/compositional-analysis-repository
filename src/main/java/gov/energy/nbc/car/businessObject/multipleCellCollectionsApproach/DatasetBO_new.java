...
import gov.energy.nbc.car.dao.mongodb.multipleCellCollectionApproach.DatasetDAO_new;
...
public class DatasetBO_new implements IDatasetBO {

    Logger log = Logger.getLogger(this.getClass());

    protected DatasetDAO_new datasetDAO;
    protected DatasetDAO_new datasetDAO_FOR_UNIT_TESTING_PURPOSES;

    protected FileReader fileReader;

    public DatasetBO_new(ISettings settings,
                         ISettings settings_forUnitTestingPurposes) {

        datasetDAO = new DatasetDAO_new(settings);
        datasetDAO_FOR_UNIT_TESTING_PURPOSES = new DatasetDAO_new(settings_forUnitTestingPurposes);
    ...
    public long deleteDataset(TestMode testMode,
        ...
        DatasetDAO_new datasetDAO = getDatasetDAO(testMode);
...
//    }
    ...
    @Override
    public DatasetDAO_new getDatasetDAO(TestMode testMode) {
