...
public class DatasetBO implements IDatasetBO {
    ...
    public DatasetBO(Settings settings,
                     Settings settings_forUnitTestingPurposes) {

        datasetDAO = new DatasetDAO(settings);
        datasetDAO_FOR_UNIT_TESTING_PURPOSES = new DatasetDAO(settings_forUnitTestingPurposes);
